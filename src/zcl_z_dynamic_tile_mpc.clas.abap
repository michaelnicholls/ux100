class ZCL_Z_DYNAMIC_TILE_MPC definition
  public
...
TT_CALCULATOR type standard table of TS_CALCULATOR .
  ...
  begin of TS_DATA,
     ...
     KEY type string,
     NUMBER type P length 16 decimals 0,
     NUMBERDIGITS type P length 16 decimals 0,
     NUMBERFACTOR type string,
     NUMBERSTATE type string,
     NUMBERUNIT type string,
     STATEARROW type string,
...
CLASS ZCL_Z_DYNAMIC_TILE_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_DYNAMIC_TILE_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_DYNAMIC_TILE_MPC=>TS_DATA' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20221213031401'.                  "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_DYNAMIC_TILE_MPC=>TS_CALCULATOR' ). "#EC NOTEXT
